...
abstract class AppLocalizations {
  ...
  /// No description provided for @toSybmol.
  ///
  /// In en, this message translates to:
  /// **'-'**
  String get toSybmol;
  ...
  ///
  /// In en, this message translates to:
  /// **'There is an error when connecting to the server. Please try again'**
  String get connectionError;

  /// No description provided for @connectTimeoutError.
  ///
  /// In en, this message translates to:
  /// **'Connecting time is too long.Please try again'**
  String get connectTimeoutError;

  /// No description provided for @receiveTimeoutError.
  ///
  /// In en, this message translates to:
  /// **'The server currently is busy,Please try agin'**
  String get receiveTimeoutError;

  /// No description provided for @otherError.
  ///
  /// In en, this message translates to:
  /// **'Unexpected error occures. Please try again'**
